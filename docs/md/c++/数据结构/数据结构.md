...
![](assets/数据结构/LinkList.png)

##### 双向链表（Du-Link-List）

双向链表图片

![](assets/数据结构/DuLinkList.png)

##### 循环链表（Cir-Link-List）

循环链表图片

![](assets/数据结构/CirLinkList.png)
...
![](assets/数据结构/GeneralizedList1.png)
...
![](assets/数据结构/GeneralizedList2.png)
...
![](assets/数据结构/SqBinaryTree.png)

##### 链式存储

二叉树链式存储图片

![](assets/数据结构/LinkBinaryTree.png)
...
![](assets/数据结构/Self-balancingBinarySearchTree.png)
